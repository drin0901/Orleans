...
namespace Movies.Contracts
{
	...
	public static class MovieDataService
	{
		...
		public static MovieDataModel GetById(int Id)
		...
		public static int AutoNumberId()
		{
			//var listMovies = Movies.OrderByDescending(x => x.Id).Select(x => x.Id + 1).Take(1);

			var listMovies = Movies.Max(x => x.Id) + 1;
